...
while continuar ==1:
    ...
    while continuar ==1:
        ...
        for alimeto,precioali,trasporte,preciotras,vivienda,preciovivi,entretenimeinto,precioentre,otros,preciootro in zip(listaalimentos,precioalimentos,listatrasporte,preciotrasporte,listavivienda,preciovivienda,listaentretenieminto,precioentretenimenito,listaotros,preciootros):
